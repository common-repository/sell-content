...
/*
Plugin Name: Sell content with Oronjo
...
function oronjo_subpanel() {
  ...
  if (isset($_POST['save_oronjo_settings'])) {
    ...
    echo '<div class="updated"><p>Sell Content with Oronjo have been saved. If you would like to import your Oronjo products into Wordpress, hit the \'Import Oronjo Products\' button.</p></div>'; 
  }
...
function oronjo_add_action_links ( $links ) {
  $mylinks = array(
  '<a href="' . admin_url('options-general.php?page=sell-content.php') . '">Settings</a>',
  );
...
function oronjo_admin_menu() {
   if (function_exists('add_options_page')) {
     oronjo_setup();
     add_options_page('Sell content Settings', 'Sell content', 8, basename(__FILE__), __NAMESPACE__.'\\oronjo_subpanel');
